...
import { LayoutDashboard, Users as UsersIcon, GraduationCap, LogOut, Menu, X } from "lucide-react";

const NAV = [
  { to: "/dashboard", label: "الرئيسية", icon: LayoutDashboard, testid: "nav-dashboard" },
  { to: "/students", label: "الطلاب", icon: GraduationCap, testid: "nav-students" },
  { to: "/users", label: "المستخدمون", icon: UsersIcon, testid: "nav-users" },
];
...
export default function AppLayout() {
  ...
  const SidebarBody = ({ onClickItem }) => (
    <div className="flex h-full flex-col bg-white">
      <div className="flex items-center gap-3 px-6 py-6 border-b border-gray-200">
        <img src="/assets/logo.png" alt="IQRA" className="h-10 w-10 object-contain" />
        <div>
          <div className="text-lg font-bold text-gray-900 leading-tight">مدرسة اقرأ</div>
      ...
      <div className="border-t border-gray-200 p-4">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
        >
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Desktop sidebar (RTL: fixed to the right via CSS) */}
      ...
      <header className="lg:hidden sticky top-0 z-30 bg-white border-b border-gray-200 flex items-center justify-between px-4 h-14">
        <div className="flex items-center gap-2">
          <img src="/assets/logo.png" alt="IQRA" className="h-8 w-8 object-contain" />
