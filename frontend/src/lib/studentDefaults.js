export const emptyStudent = () => ({
  student: {
    orphan: false, orphanOf: "", orphanDocType: "", orphanDocDescription: "",
    registrationPath: "خاص", previousClass: "", newClass: "", status: "resident",
    fullName: "", birthdate: "", birthPlace: "", currentAddress: "",
    gender: "male", languages: [], hobbies: [],
    addressCodes: { sector: "", block: "", minutes: "", floor: "", apartment: "" },
    chronicDisease: false, chronicDiseaseDetails: "",
    permanentHabits: false, permanentHabitsDetails: "",
  },
  siblings: [],
  ...
  previousEducation: [],
  islamicLegalEducation: "", bestAchievement: "",
  ...
  currentClassId: "",
  fullInfo: {
    serial: "", classSerial: "", classSection: "", serial2: "", department: "",
    generalRegNumber: "", ministerialNumber: "",
    fatherFirstName: "", familyName: "", secondName: "", tripleName: "",
    motherTripleName: "", grandfatherName: "",
    ageYears: "", nationality: "", familyStatus: "", primaryLanguage: "",
    distinctiveMarks: "", bloodType: "",
    familySize: "", siblingsInSchool: "", livesWith: "",
    housingGovernorate: "", housingRegion: "", housingDistrict: "", housingTown: "",
    recordNumber: "", housingType: "", housingOwnership: "",
    fatherMaritalStatus: "", fatherSpecialty: "",
    motherMaritalStatus: "", motherSpecialty: "",
    originalGovernorate: "", registrationAmana: "", registrationPlace: "", registrationNumber: "",
    enrollmentDate: "", enrollmentClass: "", branch: "", class2: "",
    height: "", width: "", footSize: "", uniformSize: "", weight: "",
    staffChildren: false,
  },
});
