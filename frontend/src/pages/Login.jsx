    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-white">
      ...
      <div className="hidden lg:block relative overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-between p-12 text-white">
          <img src="/assets/logo.png" alt="IQRA" className="h-16 w-16 object-contain bg-white/95 rounded-2xl p-2" />
          <div>
            <h1 className="text-4xl font-extrabold mb-3 leading-tight">
              مرحباً بك في نظام تسجيل الطلاب
            </h1>
            <p className="text-white/90 text-lg max-w-md leading-relaxed">
              منصة بسيطة وأنيقة لإدارة تسجيلات طلاب مدرسة اقرأ.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 bg-[#F8FAFC]">
        <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          <div className="lg:hidden flex items-center gap-3 mb-6">
            <img src="/assets/logo.png" alt="IQRA" className="h-12 w-12 object-contain" />
            <div>
              <div className="text-lg font-bold text-gray-900">مدرسة اقرأ</div>
          ...
          <p className="text-sm text-gray-500 mb-6">أدخل بيانات الاعتماد للوصول إلى لوحة التحكم</p>
